...
train = load_dataset('csv', data_files='/ssd_scratch/cvit/aparna/train.csv',cache_dir='/ssd_scratch/cvit/aparna/t5_data')
val = load_dataset('csv', data_files='/ssd_scratch/cvit/aparna/val.csv',cache_dir='/ssd_scratch/cvit/aparna/t5_data')
test = load_dataset('csv', data_files='/ssd_scratch/cvit/aparna/test.csv',cache_dir='/ssd_scratch/cvit/aparna/t5_data')
...
training_args = Seq2SeqTrainingArguments(
  output_dir = "/ssd_scratch/cvit/aparna/t5_simplification",
  log_level = "error",
  num_train_epochs = 10,
  learning_rate = 5e-4,
...
#save model
trainer.save_model("/ssd_scratch/cvit/aparna/t5_simplification_final")
