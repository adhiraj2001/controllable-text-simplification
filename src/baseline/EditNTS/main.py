...
def training(edit_net,nepochs, args, vocab, print_every=500, check_every=500):
    ...
    for epoch in range(nepochs):
        ...
        val_loss, bleu_score, sari, sys_out = evaluator.evaluate(eval_dataset, vocab, edit_net,args)
        log_msg = "epoch %d, Dev loss: %.4f, Bleu score: %.4f, Sari: %.4f \n" % (epoch, val_loss, bleu_score, sari)
        print(log_msg)
...
def main():
    ...
    #     edit_net = nn.DataParallel(edit_net)
